...
import { fetchAllPortfolios } from "../features/portfolio/portfolioSlice";
...
const AllPortfolioList = () => {
  ...
  const { allItems: portfolios, allLoading: loading, allError: error } = useSelector(
    ...
    <div className="min-h-screen bg-[#0F0F19] text-white flex flex-col">
      ...
      <div className="max-w-5xl mx-auto p-6 mt-10">
        ...
        {loading && portfolios.length === 0 && (
          <p className="text-center text-gray-400">Загрузка портфелей...</p>
        )}
